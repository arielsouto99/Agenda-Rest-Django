...
urlpatterns = [
    ...
    path('api/persona/lista', views.PersonListView.as_view()),
    path('api/persona/search/<kword>/', views.PersonSearchView.as_view()),
    ...
    path('api/persona/pagination/', views.PersonPaginationList.as_view()),
    path('api/reunion/por-job/', views.ReunioByPersonJob.as_view()),
]
